...
async function handle(req: IncomingMessage, res: ServerResponse) {
  ...
  // OpenMAIC's own prompts are passed through unchanged: the lesson brief (lesson.ts) carries
  // everything the lesson needs, and Sensei's study-tool brief would leak into what's taught.
